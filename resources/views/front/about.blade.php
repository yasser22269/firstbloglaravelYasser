    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <img src="{{ asset('front/images/author.jpg')  }}" alt="author" class="img-fluid w-100 mb-4">
          <h3 class="font-weight-light">Hello, I’m <span class="font-weight-bold">Yasser Abd Elghany</span></h3>
